...
<div class="container">
    ...
    <?php if ($result->num_rows == 0): ?>
        <p class="error">Abhi tak koi movie save nahi ki. Pehle search karke save karo!</p>
    <?php endif; ?>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <div class="fav-card">
                ...
                <div class="fav-info">
                    ...
                    <a href="favorites.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('Delete karna hai?')">🗑 Remove</a>
                </div>
            </div>
        <?php endwhile; ?>
    </div>
